...
class Program
{
    ...
    private const string connectionString = "Endpoint=sb://myneweventhubnsv2.servicebus.windows.net/;SharedAccessKeyName=readAndWrite;SharedAccessKey=9dtNKR6yy+4NyBEXVjozggVY4Ul7gyfai+AEhOJfb9g=;EntityPath=apphub";
